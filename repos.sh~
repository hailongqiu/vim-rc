...
case "$1" in
    ...
    "revert" )
        ...
        ;;
    "add_remote" )
        git remote add $2 git@github.com:$2/vim-rc.git
        ;;
    "pull_remote" )
        git remote add $2 git@github.com:$2/vim-rc.git || git fetch $2 && git merge $2/master
        ;;
    "fetch" )
        git fetch $2
        ;;
    ...
    "tag" )
        ...
        ;;
    "pushtag" )
        git push git@github.com:$2/vim-rc.git --tag
        ;;
    "build"  )
        debuild || dh clean
        ;;
